...
$NDK_HOME\aarch64-linux-android21-clang -fPIC -I"$JAVA_HOME/include" -I"$JAVA_HOME/include/linux" -shared -o libapi.so jni/com_jni_APITest.c -L ../libs/arm64-v8a -l log
